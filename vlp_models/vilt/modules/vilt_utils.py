...
from modules.objectives import compute_irtr_recall
...
def epoch_wrapup(pl_module):
    ...
    if pl_module.hparams.config["get_recall_metric"] and not pl_module.training:
        # ir_r1_sum, ir_r5_sum, ir_r10_sum, tr_r1_sum, tr_r5_sum, tr_r10_sum = 0, 0, 0, 0, 0, 0
        # for i in range(10):
        ...
        (ir_r1, ir_r5, ir_r10, tr_r1, tr_r5, tr_r10) = compute_irtr_recall(pl_module)
            ...
            # tr_r5_sum += tr_r5
            # tr_r10_sum += tr_r10
        # ir_r1, ir_r5, ir_r10, tr_r1, tr_r5, tr_r10 = ir_r1_sum/10, ir_r5_sum/10, ir_r10_sum/10, tr_r1_sum/10, tr_r5_sum/10, tr_r10_sum/10
